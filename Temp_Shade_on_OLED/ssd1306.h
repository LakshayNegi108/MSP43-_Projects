...
void ssd1306_printText_2(uint8_t, uint8_t, char *);
void ssd1306_printText_2_wide(uint8_t, uint8_t, char *);
void ssd1306_printText_matra(uint8_t, uint8_t, char *);
void ssd1306_printText_on_line(uint8_t, uint8_t, char *);
